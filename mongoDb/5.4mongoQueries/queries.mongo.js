// instructions to execute this queries

// 1. my database name is resto
// 2. my collection name is resto1
...
db.resto1.find({}, { restaurant_id: 1, name: 1, borough: 1, cuisine: 1 })
...
db.resto1.find({}, { _id: 0, restaurant_id: 1, name: 1, borough: 1, cuisine: 1 })
...
db.resto1.find({ "address.street": { $exists: true } })
...
db.resto1.find({ "address.coord": { $type: "double" } })
